...
%           李幼萌 Youmeng Li: liyoumeng@tju.edu.cn   天津大学软件学院软件工程系教授
%			曾俊豪 Alan Zeng: me@alanzeng.com  天津大学2021级智能与计算学部软件工程专业本科生
...
\newcommand{\sanhaoannounce}{\fontsize{16pt}{1.25\baselineskip}\selectfont}      % 三号, 单倍行距
...
\addtolength{\bibsep}{-0.5em}     % 缩小参考文献间的垂直间距 %NCS
...
\def\makecover{
    ...
    \begin{titlepage}
      	...
      	\begin{center}
  			...
  			\setlength{\@title@width}{6cm}{\song\sanhao{\textbf{
    			\begin{tabular}{lc}
      				...
      				姓\qquad 名&	\underline{\makebox[\@title@width][c]{\@cauthor}} 	\\
                        学\qquad 号&
                    \underline{\makebox[\@title@width][c]{\@cnumber}} 	\\
...
\def\makeannounce{
  ...
  \pdfbookmark[0]{独创性声明}{announce}  
  \chapter*{\vspace{4em}\centering\song\erhao\textbf{独创性声明}}
  \vspace{\baselineskip}
  \song\sanhaoannounce 本人声明：所呈交的毕业设计（论文），是本人在指导教师指导下，进行研究工作所取得的成果。除文中已经注明引用的内容外，本毕业设计（论文）中不包含任何他人已经发表或撰写过的研究成果。对本毕业设计（论文）所涉及的研究工作做出贡献的其他个人和集体，均已在论文中作了明确的说明。本毕业设计（论文）原创性声明的法律责任由本人承担。\par
  \vspace{\baselineskip}
  \hspace{8em}论文作者签名:\par
  % \hspace{16em}年\qquad月\qquad日\par
  \hspace{16em}年\hspace{2em}月\hspace{2em}日\par
  \vspace{4em}
  本人声明：本毕业设计（论文）是本人指导学生完成的研究成果，已经审阅过论文的全部内容。\par
  \vspace{\baselineskip}
  \hspace{8em}论文指导教师签名：\par
  % \hspace{16em}年\qquad月\qquad日\par
  \hspace{16em}年\hspace{2em}月\hspace{2em}日\par
%   \thispagestyle{empty}
}
...
%%%%%%%%%%%%%%%%%%%   References   %%%%%%%%%%%%%%%%%%%%%%%
\def\makereferences{
	\titleformat{\chapter}{\centering\xiaosan\hei}{\chaptername}{1em}{} % "参考文献"四号黑体顶格
	\chapter*{\bibname}
	\defaultfont
